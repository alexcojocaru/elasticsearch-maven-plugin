# Elasticsearch Maven Plugin [![Build Status](https://travis-ci.org/alexcojocaru/elasticsearch-maven-plugin.png?branch=es5)](https://travis-ci.org/alexcojocaru/elasticsearch-maven-plugin)
